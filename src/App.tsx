  ...
  return (
    <AppWrapper>
      ...
      <FieldWrapper>
        ...
        <Input type="text" onChange={sortName} autoComplete="off" />
      </FieldWrapper>
      <FieldWrapper>
        <label htmlFor="name">
          Your next birthday (please enter in the format month/day/year eg.
          12/30/2022):
        </label>
        <Input type="text" onChange={sortBirthdate} autoComplete="off" />
      </FieldWrapper>
